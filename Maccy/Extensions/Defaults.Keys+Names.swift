...
extension Defaults.Keys {
  ...
  static let dailyExportCatchUpDays = Key<Int>("dailyExportCatchUpDays", default: 7)
  static let dailyExportCleanupOrphans = Key<Bool>("dailyExportCleanupOrphans", default: true)
  static let dailyExportEnabled = Key<Bool>("dailyExportEnabled", default: false)
  static let dailyExportHour = Key<Int>("dailyExportHour", default: 0)
  static let dailyExportMinute = Key<Int>("dailyExportMinute", default: 5)
  ...
  static let size = Key<Int>("historySize", default: 10_000)
